...
'store_outdet':[
	{srcNodeId:"store_rec",destNodeId:"store_outdet",layout:"",whereSql:"store_num > 0 and store_id not in (select store_id from store_outdet where out_id = {FKEYID})",whereType:"",whereValue:""}
],
'sys_fun_col':[
