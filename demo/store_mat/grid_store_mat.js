Jxstar.currentPage = function() {
	...
	{col:{header:'分类名称', width:100, sortable:true, editable:true, hcss:'color:#2E6DA4;',
	...
	{col:{header:'主键', width:100, sortable:true, colindex:10000, editable:true, hcss:'color:#2E6DA4;',
		editor:new Ext.form.TextField({
			maxLength:25
		})}, field:{name:'store_mat__mat_id',type:'string'}},
	...
	config.param.notNullFields = 'store_mat__mat_code;store_mat__mat_name;';
