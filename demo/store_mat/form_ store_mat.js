		...
		items:[{
			...
			items:[{
				...
				items:[
					...
					{xtype:'textfield', fieldLabel:'分类编码', name:'store_mat__type_code', anchor:'100%', maxLength:50},
					{xtype:'textfield', fieldLabel:'备注', name:'store_mat__mat_desc', anchor:'100%', maxLength:50},
				...
				items:[
					...
					{xtype:'textfield', fieldLabel:'单位', name:'store_mat__mat_unit', anchor:'100%', maxLength:50},
					{xtype:'textfield', fieldLabel:'物资编码', name:'store_mat__mat_code', allowBlank:false, labelStyle:'color:#0077FF;', labelSeparator:'*', anchor:'100%', maxLength:50},
