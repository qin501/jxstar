Jxstar.currentPage = function() {
	...
	{col:{header:'入库单号', width:130, sortable:true}, field:{name:'store_in__in_code',type:'string'}},
	{col:{header:'入库日期', width:123, sortable:true, align:'center',
		renderer:function(value) {
			return JxUtil.renderDate(value, 'Y-m-d');
		}}, field:{name:'store_in__in_date',type:'date'}},
	{col:{header:'仓库', width:144, sortable:true}, field:{name:'store_in__house_name',type:'string'}},
	...
	{col:{header:'入库说明', width:323, sortable:true}, field:{name:'store_in__in_desc',type:'string'}},
