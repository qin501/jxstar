...
<body>
	<div class="wraper">
		<div class="btn-wraper">
			<input type="button" class="btn btn-success" value="添加附件" id="browseBtn" />
			<!--<input type="button" class="btn btn-success" value="2-确定上传" id="uploadBtn" />-->
		</div>
		<ul id="file-list">
			<span class="loading">正在加载附件 ...</span>
		</ul>
	</div>
	<iframe id="frmhiddenxx" name="frmhiddenxx" style="display:none;"></iframe>
	<!--<div id="drop-area">
		<span>选择文件拖动到此区域可以上传！</span>
	</div>-->
	<script>
