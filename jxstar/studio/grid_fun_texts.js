Jxstar.currentPage = function() {
	...
	var cols = [
	{col:{header:'*键值', width:268, sortable:true, editable:true, hcss:'color:#0077FF;',
	...
	{col:{header:'来源', width:89, sortable:true, align:'center',
		editable:false,
	...
	{col:{header:'类型', width:100, sortable:true, hidden:true, align:'center',
		editable:false,
		editor:new Ext.form.ComboBox({
			store: new Ext.data.SimpleStore({
				fields:['value','text'],
	...
	{col:{header:'英文描述', width:488, sortable:true, editable:true, hcss:'color:#2E6DA4;',
		editor:new Ext.form.TextField({
			maxLength:500
	...
	{col:{header:'繁体描述', width:100, sortable:true, hidden:true}, field:{name:'funall_text__prop_value_bg',type:'string'}}
	];
